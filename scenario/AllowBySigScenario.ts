...
scenario("Comet#allowBySig > allows a user to authorize a manager by signature", {}, async ({ comet, actors }, context, world) => {
...
scenario("Comet#allowBySig > fails if owner argument is altered", {}, async ({ comet, actors }, context, world) => {
...
scenario("Comet#allowBySig > fails if manager argument is altered", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty, charles } = actors;
...
scenario("Comet#allowBySig > fails if isAllowed argument is altered", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig > fails if nonce argument is altered", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig > fails if expiry argument is altered", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig fails if signature contains invalid nonce", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig rejects a repeated message", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig fails for invalid expiry", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig fails if v not in {27,28}", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
...
scenario("Comet#allowBySig fails if s is too high", {}, async ({ comet, actors }, context, world) => {
  const { albert, betty } = actors;
