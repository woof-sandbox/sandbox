...
scenario.skip("Compound v2 > allows a user to repay, borrow, repay cETH", {}, async (_, context, world) => {
...
scenario.skip("Compound v2 > allows a user to mint & redeem cDAI", {}, async (_, context, world) => {
  const dm = context.world.deploymentManager;
...
scenario.skip("Compound v2 > allows a user to mint & redeem cUSDC", {}, async (_, context, world) => {
  const dm = context.world.deploymentManager;
...
scenario.skip("Compound v2 > allows a user to repay, borrow, repay cWBTC2", {}, async (_, context, world) => {
  const dm = context.world.deploymentManager;
