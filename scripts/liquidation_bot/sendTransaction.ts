...
function isFlashbotsTxnResponse(
  bundleReceipt: FlashbotsTransactionResponse | RelayResponseError
): bundleReceipt is FlashbotsTransactionResponse {
  return (bundleReceipt as FlashbotsTransactionResponse).bundleTransactions !== undefined;
}

async function sendFlashbotsBundle(txn: PopulatedTransaction, signerWithFlashbots: SignerWithFlashbots): Promise<boolean> {
...
export async function sendTxn(txn: PopulatedTransaction, signerWithFlashbots: SignerWithFlashbots): Promise<boolean> {
