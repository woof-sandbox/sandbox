...
describe("VerifyArgs", () => {
  it("gets, sets, and deletes verify args", async () => {
    ...
    const testContract = await deploy("test/Dog.sol", ["spot", "0x0000000000000000000000000000000000000001", []], hre, {
      cache,
      network: "test-network",
    });
    const verifyArgs1: VerifyArgs = {
      via: "artifacts",
      address: "0x0000000000000000000000000000000000000000",
      constructorArguments: [],
    };
    const verifyArgs2: VerifyArgs = {
      via: "buildfile",
      contract: testContract,
      buildFile: faucetTokenBuildFile,
      deployArgs: [],
    };
