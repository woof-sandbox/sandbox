...
abstract contract ISandboxComet is CometCore {
  ...
  function setControllerFee(bool disabled) external virtual;
  ...
  function quoteCollateral(address asset, uint baseAmount) public view virtual returns (uint, uint, uint);
