...
import "./interfaces/ISandboxController2.sol";
...
contract ConfigController is IConfigController {
    ...
    ISandboxController2 public sandboxController;
    ...
    constructor(
        ...
        owner = _owner;
        guardian = _guardian;
        sandboxController = ISandboxController2(_sandboxController);
    ...
    function createMarket(
        ...
        ISandboxController2.CollateralTokenConfig memory collateralAssetLimitations;
