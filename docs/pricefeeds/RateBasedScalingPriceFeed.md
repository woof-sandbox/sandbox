...
```solidity
constructor(address underlyingPriceFeed_, uint8 decimals_, uint8 underlyingDecimals_, string description_, address underlyingToken_) public
```
...
| underlyingDecimals_ | uint8 | The number of decimals for the underlying price feed |
