...
import { SimplePriceFeed__factory, MultiplicativePriceFeed__factory } from "../../build/types";
...
describe.skip("Multiplicative price feed", function () {
  it("reverts if constructed with bad decimals", async () => {
    ...
    const MultiplicativePriceFeed = (await ethers.getContractFactory("MultiplicativePriceFeed")) as MultiplicativePriceFeed__factory;
    await expect(
